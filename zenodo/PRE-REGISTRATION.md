...
*Written 18 August 2026. Scope corrected 19 September 2026, before deposit and
before any Queensland or Northern Territory record has been opened. Deposited
for citation so that the protocol is on the record ahead of the results.*

**Status: FROZEN ON DEPOSIT — do not edit after that.** Departures from this
protocol get recorded in the results, not backported here. If the protocol
needs to change after deposit, that is a version 2 with its own date and its
own reason.

> **Amendment, 19 September 2026 — recorded rather than silently applied.**
>
> As first written, this document claimed to precede the audit of five
> jurisdictions: Queensland, the Northern Territory, Western Australia, South
> Australia and Tasmania. That claim does not hold for the last three. The
> repository's own history shows the enforcement research covering NSW, VIC,
> TAS, WA and SA committed at 16:11 on 18 August, and this document committed
> at 16:25 — fourteen minutes later. Commit time is not authoring time, and the
> protocol may well have been written first; but a pre-registration's force
> comes from *demonstrable* priority, and the public record cannot demonstrate
> it here.
>
> The scope is therefore narrowed to **Queensland and the Northern Territory**,
> where priority is not in doubt because no record in either has been opened.
> Western Australia, South Australia and Tasmania move to the exploratory half
> alongside Victoria and New South Wales, and must be reported as exploratory.
>
> This correction is made before deposit, which is why it is an amendment to
> version 1 rather than a version 2. It is recorded here rather than applied
> quietly because the uncorrected text has been public in the repository since
> 18 August, and a pre-registration that edits its own scope without saying so
> is worth less than no pre-registration at all.
...
Victoria and New South Wales were audited before this document existed, and —
per the amendment above — Western Australia, South Australia and Tasmania
cannot be shown to postdate it. All five are **exploratory**: they found the
pattern and produced the protocol. This pre-registration covers the
**confirmatory** run across Queensland and the Northern Territory, whose
answers are not known at the time of writing. The distinction is stated here
rather than blurred, and must be stated in anything published from either half.

An exploratory finding is not a lesser finding. The five-jurisdiction result —
that no instrument of approval examined imposes a numeric energy or water
condition — stands on the documents it read. What it cannot claim is that its
search terms and record set were fixed before anyone saw the answer.
...
- **Jurisdictions:** Queensland and the Northern Territory. (Western Australia,
  South Australia and Tasmania were in the original scope and are now
  exploratory — see the amendment above.)
- **Note on the Northern Territory, recorded in advance:** as at 19 September
  2026 the tracker holds no NT data centre — its only NT row is a rare-earths
  mine. The NT arm therefore begins at step 1 of the search frame below, and a
  null result for the territory must be reported as "no facility located by
  these indexes", never as "no facility exists".
