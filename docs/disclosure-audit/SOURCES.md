...
Every document the disclosure audit has read. **The files themselves are not
committed** — see `.gitignore`. Reproducibility comes from the **sha256**:
fetch the document from its source, run `shasum -a 256`, and a match means you
are reading the same bytes.

| File | Size | sha256 | Retrieved |
| --- | --- | --- | --- |
| `aemo_vapr_2026.pdf` | 9.4 MB | `5afe919092de54bdedeabbd135c7c2a5c9a01cb4ad05f31245137d69a0e1fa31` | 2026-09-19 |
...
| `tasnetworks_apr_2025_summary.pdf` | 5.5 MB | `7f789c399b8b935ec0df5bc39f0f847d5bae41f809962822dea8fb66668a42c9` | 2026-09-19 |
| `transgrid_tapr_2026.pdf` | 33.8 MB | `5dae8e3201debe035dee8f1bb3ee67d83b8bf25b1e49255dd3e8f8cd492e1ed1` | 2026-09-19 |
| `westernpower_tsp_2025.pdf` | 3.1 MB | `9b34f830dd31ebe26fece4cfa1126702c3a48c97570ae53ea9b8a0bf46c7224a` | 2026-09-19 |
